...
const DUNGEONS = [
    {
        ...
        type: 'Blue Gate',
        recommendedLevel: 1,
        description: 'A basic training facility for awakening hunters. Focus on fundamental movements and full-body recruitment.',
        requirements: ['Squat', 'Bench Press', 'Barbell Row'],
        targetWorkouts: 5,
        xpReward: 500,
    ...
    },
    {
        ...
        type: 'Blue Gate',
        recommendedLevel: 15,
        description: 'Test your endurance in the depths of the labyrinth. Emphasis on posterior chain and core stabilization.',
        requirements: ['Deadlift', 'Overhead Press', 'Pull Up', 'Russian Twists'],
        targetWorkouts: 12,
        xpReward: 2500,
    ...
    },
    {
        ...
        type: 'Red Gate',
        recommendedLevel: 35,
        description: 'Only high-ranking hunters should attempt this gate. Extreme upper-body intensity and explosive power required.',
        requirements: ['Pushups', 'Incline Bench Press', 'Weighted Pull Ups', 'Dumbbell Curls'],
        targetWorkouts: 20,
        xpReward: 10000,
    ...
    },
    {
        ...
        type: 'Purple Gate',
        recommendedLevel: 50,
        description: 'The pinnacle of the system. Face the monarch of destruction. Requires mastery of all muscle sectors.',
        requirements: ['Elite PR Attempt', 'Full Body Raid', 'Plank', 'Heavy Squat'],
        targetWorkouts: 30,
        xpReward: 25000,
        loot: 'Monarch Border',
        color: '#a33fe3',
